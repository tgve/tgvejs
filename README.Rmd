...
Please see the repository's [wiki](https://github.com/layik/eAtlas/wiki/Using-TGVE)
for details of how to host your own eAtlas using Github Pages, or other ways of using TGVE.
...
The frontend is a [`create-react-app`](https://create-react-app.dev/docs/getting-started/) (CRA) so all the standard commands of CRA applies.
...
This repository contains a Dockerfile for production. If you just want to pull the image, it is built on [hub.docker.com](https://hub.docker.com/r/layik/eatlas), if you just want to run the image. If you like to build it yourself, see below. Again remember to change the production URL and hopefully better documentations in future.
